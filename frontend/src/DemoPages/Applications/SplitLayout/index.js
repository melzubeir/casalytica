...
//                             <CardTitle className="text-white mx-auto mb-0 font-size-lg text-capitalize fw-normal">
//                               Left Split Panel
//                             </CardTitle>
//                           </CardBody>
//                         </Card>
...
//                           <CardBody className="center-elem">
//                             <CardTitle className="mx-auto mb-0 font-size-lg text-capitalize fw-normal">
//                               Right Split Panel
//                             </CardTitle>
//                           </CardBody>
//                         </Card>
