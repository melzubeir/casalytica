      ...
      <Fragment>
        <TransitionGroup>
          <CSSTransition component="div" classNames="TabsAnimation" appear={true}
            ...
            <div>  
              <Form>
                <FormGroup inline className="mb-2 me-sm-2 mb-sm-0">
                  <Label for="exampleEmail22" className="me-sm-2">
                    Email
                  </Label>
                  <Input type="email" name="email" id="exampleEmail22" placeholder="something@idk.cool"/>
                </FormGroup>
                <FormGroup inline className="mb-2 me-sm-2 mb-sm-0">
                  <Label for="examplePassword22" className="me-sm-2">
                    Password
                  </Label>
              ...
              <Form inline>
                ...
                <FormGroup>
                  ...
                  <Input type="password" className="me-2" name="password" id="examplePassword44" placeholder="Password"/>
                </FormGroup>{" "}
